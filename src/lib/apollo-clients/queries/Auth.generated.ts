...
export type CreateAtMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type CreateAtMutation = { createAT: { __typename: 'AuthResponseType', code: number, success: boolean, message: string, data: Array<boolean | null> } };
...
export const CreateAtDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateAT"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createAT"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"data"}}]}}]}}]} as unknown as DocumentNode<CreateAtMutation, CreateAtMutationVariables>;